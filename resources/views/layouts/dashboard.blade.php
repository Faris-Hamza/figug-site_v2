...
<body class="g-sidenav-show  bg-gray-100">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">metaTech</a>
                for a better web.
              </div>
            </div>
          </div>
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">fondation oriental figug</h5>
  ...
  <script src="{{asset('assets_dashboard/js/soft-ui-dashboard.min.js?v=1.0.5')}}"></script>
  <script src="https://kit.fontawesome.com/8736b37188.js" crossorigin="anonymous"></script>
