...
@section('Content')
    <div class="px-4 py-5 my-1 text-center">
        <h1 class="display-5 fw-bold">{{__('rapport.new')}}</h1>
        <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">{{__('info.not')}}</p>
        <hr>
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <a href="{{route('rapports')}}" class="btn btn-primary btn-lg px-4 gap-3">{{__('rapport.all')}}</a>
        </div>
        </div>
    </div>
        ...
        <form action="{{route('rapport/store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea  class="form-control" name="context[{{$key}}]"></textarea>
                </div>
                <div class="mb-3">
            ...
            @endforeach
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nbr_femme" >
                </div>
                <div class="mb-3">
                    <label for="nbr_homme" class="form-label fw-bold">{{__('rapport.nbrHomme')}}</label>
                    <input type="text" class="form-control" name="nbr_homme" >
                </div>
