...
<head>
    <meta charset="utf-8">
    <title>{{__('rapport.Rapport')}} {{$Rapport->activite()->first()->name}}</title>
</head>
<body>
    <style>
        .container{
        ...
        <div class="content-center">
            <h2>{{__('rapport.Rapport')}}<br> <span class="title_">{{ $Rapport->activite()->first()->name }}</span></h2>
        </div>
        <div class="title">
            <h2>{{__('rapport.Résumé')}} :</h2>
        </div>
        <div class="para">
