  ...
  <div class="container">
    <div class="row">
        <div class="px-2 py-5 my-2 text-center">
            <h1 class="display-5 fw-bold">{{__('partenaire.header')}}</h1>
      ...
      <div class="col-12">
          <div class="card mb-4">
              <div class="card-header pb-0">
                  <div class="row">
                      <h6 class="col" style="align-self: center;">{{__('partenaire.partenaire')}}</h6>
                      <div class="col search">
                          <div class="button_save">
                              <a class="btn bg-gradient-primary mt-3 w-100" href="{{ route('partenaire/create') }}">
                                  {{__('partenaire.btn_add')}}
                              </a>
                          </div>
                      </div>
                                  ...
                                  <table class="table align-items-center mb-0">
                                      ...
                                      <tr>
                                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                              {{__('global_translate.logo')}}
                                          </th>
                                          <th
                                              class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                              {{__('global_translate.name')}}
                                          </th>
                                          <th
                                              class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                              {{__('partenaire.lien')}}
                                      ...
                                      @foreach ($partenaires as $item)
                                          <tr>
                                              ...
                                              <td class="align-middle text-center">
                                                  <a href="{{ $item->url }}" target="_blank"><span class="mb-0 text-sm">{{__('partenaire.Site')}}</span></a>
                                              </td>
